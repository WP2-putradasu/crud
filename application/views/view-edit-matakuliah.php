                ...
                <tr>
                    ...
                    <td>
                        <select name="sks" id="sks">
                            ...
                            <option value="5"<?php if($sks==5) echo 'selected';?>>5</option>
                            <option value="6"<?php if($sks==6) echo 'selected';?>>6</option>
                            <option value="7"<?php if($sks==7) echo 'selected';?>>7</option>
